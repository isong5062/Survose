...
def generate_survey_text(topic=None):
    ...
    response = client.responses.create(
        model="gpt-5.2",
        input=f"""
        You are a survey generation assistant. You will be given a topic and you will need to generate 5, non-biased survey questions that are appropriate for the topic.
        TOPIC: {topic}
        """
    )
